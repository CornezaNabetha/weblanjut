    ...
    <div class="container mt-4">
        <form action="/updateProfile/{{ $profile->id }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" required="required" name="name" value="{{ $profile->name }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control" required="required" name="gambar"
                        value="{{ $profile->foto }}"></br>
                    <img src="{{ asset('storage/'.$profile->foto) }}" width="150px" alt="">
            </div>
            <button type="submit" name="edit" class="btn btn-primary float-right">Edit Profile</button>
        </form>
