        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    @endcan
                    @can('user-display')
                        <li><a class="nav-link" href="https://www.instagram.com/pesonaindonesiaofficial">Contact</a>
                        </li>
                    @endcan
            ...
            <form action="/article/update/{{ $article->id }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" required="required" name="gambar"
                        value="{{ $article->gambar }}"></br>
                    <img src="{{ asset('storage/'.$article->gambar) }}" width="150px" alt="">
