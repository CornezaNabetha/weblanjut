...
Route:: get('masakan','HomeController@masakan')->name('masakan');

Route::get('resep','HomeController@resep');

Route::get('restoran','HomeController@restoran');

Route::get('wisata','HomeController@wisata');

Route::get('manageUser', 'home1Controller@manageUser');

Route::get('/editProfile/{id}', 'home1Controller@editProfile');

Route::post('/updateProfile/{id}', 'home1Controller@updateProfile');

Route::get('/user/cetak_pdf', 'home1Controller@cetak_pdf_user');
