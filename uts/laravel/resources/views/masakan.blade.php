...
<div class="col">
  <div class="row">
    ...
    <h1>Masakan Nusantara dan Internasional</h1>
  </div>
</div>
...
<div class="container">
  ...
  <div class="col-md-4">
 <div class="card">
  <img src="{{$msk -> gambar}}" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">{{$msk -> judul}}</h5>
    <p class="card-text"></p>
    <a href="https://selerasa.com/resep-dan-cara-membuat-sate-padang-asli-yang-enak-dan-nikmat" class="btn btn-primary">Click Here !</a>
  </div>
  </div>
  </div>
@endforeach 
